...
- [case](/ru/api/case) - Преобразование между форматами (camel, pascal, kebab, snake)

### ✅ Валидация
Проверка и валидация строк

- [checks](/ru/api/checks) - Проверки типов и форматов (isEmpty, isAlpha и т.д.)
...
- [pad](/ru/api/pad) - Выравнивание строк
- [indent](/ru/api/indent) - Добавление/удаление отступов

### 🔐 Безопасность
Безопасные операции со строками

- [escape](/ru/api/escape) - Экранирование спецсимволов
- [strip](/ru/api/strip) - Удаление тегов и содержимого

### ✨ Обеспечение
Гарантия формата

- [ensure](/ru/api/ensure) - Обеспечение префикса/суффикса
